        ...
        <div className="flex flex-col md:flex-row gap-12">
          ...
          <div className="md:w-2/3 grid gap-8">
            {testimonials.map((t) => (
              <div
                key={t.id}
                className="bg-bg-secondary p-8 border border-brand-charcoal/5 shadow-sm hover:shadow-md transition-shadow"
              >
                <div className="font-mono text-[10px] text-brand-orange mb-4 flex justify-between">
                  <span>ENTRY: {t.id}</span>
                  <span>// VERIFIED USER</span>
                </div>
                <blockquote className="font-lora text-lg text-text-primary leading-relaxed mb-6">
                  "{t.quote}"
                </blockquote>
                <div className="flex items-center gap-4 border-t border-brand-charcoal/5 pt-6">
                  ...
                  <div>
                    <div className="font-poppins font-bold text-sm text-text-primary">
                      {t.author}
                    </div>
