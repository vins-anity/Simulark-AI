              ...
              <>
                {user ? (
                  ...
                  <div className="flex items-center gap-4">
                    <Link
                      href="/auth/signin"
                      className="font-mono text-xs uppercase tracking-widest text-brand-charcoal hover:text-brand-orange transition-colors"
                    >
                      [ Login ]
                    </Link>
              ...
              <div className="flex gap-4">
                {["twitter", "github", "linkedin"].map((social) => (
                  <a
                    key={social}
                    href="#"
                    className="w-8 h-8 flex items-center justify-center border border-brand-charcoal/10 hover:border-brand-charcoal hover:bg-brand-charcoal hover:text-white transition-all"
                  >
