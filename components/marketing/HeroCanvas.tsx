    ...
    nodes: [
      ...
      },
      {
        ...
        data: {
          ...
          logo: "logos:aws",
          description:
            "High-availability Layer 7 load balancing with dynamic routing.",
        },
      },
      {
        id: "app",
        ...
        data: {
          ...
          logo: "logos:bun",
          description:
            "High-performance edge runtime for authenticated business logic.",
        },
      },
      {
        id: "app-2",
        ...
        data: {
          ...
          logo: "logos:go",
          description:
            "Concurrent background processor for long-running compute tasks.",
        },
      },
      {
        id: "db",
        ...
        data: {
          ...
          description:
            "ACID-compliant relational persistence with multi-region replicas.",
        },
      },
    ],
    edges: [
    ...
    nodes: [
      {
        ...
        data: {
          ...
          description:
            "Authenticated entry point for AI inference orchestration.",
        },
      },
      {
        id: "queue",
        ...
        data: {
          ...
          description:
            "Distributed event log for asynchronous inference pipeline.",
        },
      },
      {
        id: "worker",
        ...
        data: {
          ...
          description:
            "Neural network execution on high-density H100 GPU clusters.",
        },
      },
      {
        id: "vector",
        ...
        data: {
          ...
          logo: "logos:postgresql",
          description:
            "High-dimensional embedding storage for semantic retrieval.",
        },
      },
    ],
    edges: [
      ...
      },
      {
        ...
        target: "worker",
        animated: true,
        data: { protocol: "queue", complexity: "high" },
        type: "simulation",
      },
      {
        id: "e3",
    ...
    nodes: [
      {
        ...
        data: {
          ...
          description:
            "Intelligent reverse proxy and service discovery gateway.",
        },
      },
      {
        id: "auth",
      ...
      },
      {
        ...
        data: {
          ...
          logo: "logos:rust",
          description:
            "Memory-safe transaction processing and ledger integration.",
        },
      },
      {
        id: "inv",
        ...
        data: {
          ...
          logo: "logos:java",
          description:
            "Global stock synchronization and warehouse management logic.",
        },
      },
      {
        id: "cache",
        ...
        data: {
          ...
          logo: "logos:redis",
          description:
            "Sub-millisecond data retrieval for hot inventory items.",
        },
      },
    ],
    edges: [
...
function HeroCanvasInner() {
  ...
  const [nodes, setNodes, onNodesChange] = useNodesState(
    TEMPLATES.webapp.nodes,
  );
  const [edges, setEdges, onEdgesChange] = useEdgesState(
    TEMPLATES.webapp.edges,
  );
