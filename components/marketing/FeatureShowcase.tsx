        ...
        <section className="py-32 bg-white relative overflow-hidden border-b border-brand-charcoal/5">
            <div className="container mx-auto px-6">
                <div className="flex flex-col md:flex-row justify-between items-end mb-20 border-b border-brand-charcoal/10 pb-6">
                    <div>
                        <h2 className="text-4xl font-poppins font-bold text-brand-charcoal mb-2">The Architecture Pipeline</h2>
                        <p className="font-mono text-xs text-brand-gray-mid uppercase tracking-widest">From thought to infrastructure</p>
                    </div>
                    <div className="hidden md:block">
                        <Icon icon="lucide:arrow-right" className="w-8 h-8 text-brand-orange animate-pulse" />
                    </div>
                </div>
                        ...
                        >
                            <div className="mb-6 flex items-center justify-between">
                                ...
                                <div className="w-12 h-12 bg-white border border-brand-charcoal/10 rounded-full flex items-center justify-center shadow-sm group-hover:shadow-md transition-all">
                                    <Icon icon={step.icon} className="w-5 h-5 text-brand-charcoal" />
                                </div>
                            </div>
