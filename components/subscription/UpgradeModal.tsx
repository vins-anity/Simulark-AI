        ...
        <div className="p-6 border-b border-brand-charcoal/10 bg-white">
          <DialogHeader>
            ...
            <DialogDescription className="font-lora italic text-brand-gray-mid">
              Unlock advanced architectural capabilities and higher generation
              limits.
            </DialogDescription>
          </DialogHeader>
        </div>
            ...
            return (
              ...
              >
                ...
                <div className="mb-4">
                  ...
                  <p className="text-[11px] text-brand-gray-mid mt-2 font-lora italic leading-tight">
                    {plan.description}
                  </p>
                </div>
                ...
                <ul className="space-y-2 mb-6 flex-1">
                  {plan.features.slice(0, 6).map((feature, i) => (
                    <li
                      key={i}
                      className="flex items-start gap-2 text-[10px] text-brand-charcoal/80"
                    >
