        ...
        <div className="container mx-auto max-w-3xl">
          <div className="prose prose-lg prose-stone max-w-none font-lora">
            ...
            <p className="lead text-xl text-brand-charcoal/80 mb-8">
              Your privacy is important to us. This policy outlines how Simulark
              collects, uses, and protects your data.
            </p>

            <section className="mb-8">
              <h2 className="font-poppins text-2xl font-semibold mb-4 text-brand-charcoal">
                1. Information We Collect
              </h2>
              <p>
                We collect information that you provide directly to us, such as
                when you create an account, create a project, or contact us for
                support. This may include your name, email address, and project
                details.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc pl-6 space-y-2 mt-4">
                ...
                <li>
                  Understand and analyze how you use our services to improve
                  them.
                </li>
              </ul>
            </section>
            ...
            <section className="mb-8">
              ...
              <p>
                ...
                the policy and, in some cases, providing you with additional
                notice.
              </p>
            </section>
