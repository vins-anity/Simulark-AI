        ...
        <div className="container mx-auto max-w-3xl">
          <div className="prose prose-lg prose-stone max-w-none font-lora">
            ...
            <p className="lead text-xl text-brand-charcoal/80 mb-8">
              By accessing or using Simulark, you agree to be bound by these
              Terms of Service.
            </p>
            ...
            <section className="mb-8">
              ...
              <p>
                ...
                Simulark Inc. and its licensors. The service is protected by
            ...
            <section className="mb-8">
              ...
              <p>
                In no event shall Simulark Inc., nor its directors, employees,
