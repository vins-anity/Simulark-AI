    ...
    return (
      <div className="flex items-center justify-center h-full min-h-[50vh]">
        <Icon
          ...
          className="w-8 h-8 animate-spin text-brand-charcoal"
        />
      </div>
    );
  }
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="col-span-1">
              <div className="bg-white border border-brand-charcoal/10 p-6 flex flex-col items-center text-center">
                ...
                <div className="font-mono text-xs text-brand-charcoal/40 uppercase tracking-widest mb-1">
                  ID: {user?.id?.slice(0, 8)}
                </div>
                <div className="font-poppins font-bold text-lg text-brand-charcoal">
                  {user?.email}
                </div>
              </div>
            </div>
            ...
            <div className="col-span-1 md:col-span-2 space-y-6">
              <div className="grid gap-2">
                <Label
                  htmlFor="fullName"
                  className="font-mono text-[10px] uppercase tracking-widest text-brand-charcoal/60"
                >
                  Operator Name
                </Label>
                <Input
          ...
          <div className="bg-white border border-brand-charcoal/10 p-8 space-y-8">
            <div className="grid gap-2">
              ...
              <Select value={cloudProvider} onValueChange={setCloudProvider}>
                <SelectTrigger
                  id="cloud"
                  className="rounded-none border-brand-charcoal/20 bg-[#faf9f5] h-12 focus:ring-0"
                >
