    ...
    <div className="font-sans flex flex-col min-h-screen">
      ...
      <div className="max-w-4xl mb-16 space-y-6">
        ...
        <p className="text-xl text-brand-gray-mid font-lora italic max-w-2xl leading-relaxed">
          Pre-configured architectural patterns for rapid deployment. Select a
          blueprint to initialize your project.
        </p>
      </div>
              ...
              <div className="mt-auto pt-6 border-t border-brand-charcoal/5">
                <div className="flex flex-wrap gap-2 mb-6">
                  {template.tags.map((tag) => (
                    <span
                      key={tag}
                      className="text-[10px] px-2 py-0.5 border border-brand-charcoal/10 text-brand-charcoal/60 font-mono uppercase tracking-wide"
                    >
                      {tag}
                    </span>
                  ))}
