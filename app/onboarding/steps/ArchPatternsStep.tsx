...
const ARCHITECTURE_PATTERNS = [
  { id: "monolith", label: "Monolithic", icon: "ph:cube-fill", description: "Unified codebase, simplified deployment" },
  { id: "microservices", label: "Microservices", icon: "ph:squares-four-fill", description: "Distributed services, high scalability" },
  { id: "serverless", label: "Serverless", icon: "ph:lightning-fill", description: "Event-driven, scale-to-zero compute" },
  { id: "event-driven", label: "Event Driven", icon: "ph:arrows-left-right-bold", description: "Asynchronous communication via brokers" },
  { id: "jamstack", label: "Jamstack", icon: "ph:layers-fill", description: "Pre-rendered static sites with APIs" },
  { id: "clean-arch", label: "Clean Arch", icon: "ph:circle-wavy-check-fill", description: "Separation of concerns, decoupled logic" },
];
...
export function ArchPatternsStep({ selected, onChange }: ArchPatternsStepProps) {
    ...
    >
      ...
      <motion.div variants={itemVariants} className="mb-8 text-center">
        ...
        <p className="mt-1 text-sm text-brand-charcoal/60 max-w-lg mx-auto">
          Choose one or more patterns. Selecting both Monolith and Microservices favors a Modular Monolith approach.
        </p>
      </motion.div>
            ...
            >
              <div className="flex items-center gap-3 mb-2">
                <div className={cn(
                  ...
                  isSelected ? "border-brand-orange bg-brand-orange/10" : "border-brand-charcoal/10 bg-bg-tertiary"
                )}>
                  <Icon icon={pattern.icon} className={cn("w-5 h-5", isSelected ? "text-brand-orange" : "text-brand-charcoal/70")} />
                </div>
                <span className={cn(
      ...
      <motion.div variants={itemVariants} className="mt-8 text-center">
        <p className="text-[10px] text-brand-charcoal/50 font-mono">
          <span className="text-brand-orange">NOTE:</span> These preferences act as strong "gravity" for the AI generator.
        </p>
      </motion.div>
    </motion.div>
  );
