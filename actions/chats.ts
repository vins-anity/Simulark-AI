...
export async function getProjectChats(projectId: string): Promise<{ chats: Chat[]; error?: string }> {
...
export async function getChatWithMessages(chatId: string): Promise<{ chat?: Chat; messages: ChatMessage[]; error?: string }> {
    const supabase = await createClient();
...
// Create a new chat
export async function createChat(projectId: string, title: string = "New Chat"): Promise<{ chat?: Chat; error?: string }> {
    const supabase = await createClient();
...
// Update chat title
export async function updateChatTitle(chatId: string, title: string): Promise<{ error?: string }> {
    const supabase = await createClient();
...
// Delete a chat
export async function deleteChat(chatId: string, projectId: string): Promise<{ error?: string }> {
    const supabase = await createClient();
...
export async function getOrCreateDefaultChat(projectId: string): Promise<{ chat: Chat; error?: string }> {
    const supabase = await createClient();
